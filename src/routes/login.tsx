  ...
  return (
    <div className="relative flex min-h-svh w-full items-center justify-center bg-background px-4 py-4 sm:px-6 sm:py-6">
      ...
      <motion.div
        ...
        className="relative z-10 grid w-full max-w-[900px] overflow-hidden rounded-2xl border border-border bg-card text-card-foreground shadow-[0_30px_80px_-30px_rgba(6,20,45,0.35)] sm:rounded-3xl md:min-h-[580px] md:grid-cols-[minmax(0,5fr)_minmax(0,7fr)] dark:shadow-[0_30px_80px_-30px_rgba(0,0,0,0.6)]"
      >
