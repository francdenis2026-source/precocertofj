            ...
            <section className="rounded-3xl border border-border bg-surface p-5">
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0 flex-1">
                  <span className="inline-block rounded-full bg-primary/10 px-2.5 py-0.5 font-mono text-[9px] font-semibold uppercase tracking-widest text-primary">
                    {data.category}
                  </span>
              ...
              <section className="relative overflow-hidden rounded-3xl border border-savings/30 bg-gradient-to-br from-savings/15 via-savings/5 to-transparent p-5">
                ...
                <div className="relative">
                  <div className="flex items-center gap-1.5">
                    ...
                    <p className="font-mono text-[10px] font-bold uppercase tracking-widest text-savings">
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="text-right">
                          ...
                          {isBest && (
                            <p className="font-mono text-[9px] font-semibold uppercase tracking-widest text-savings">
                              melhor preço
                            </p>
                          )}
                        </div>
...
function PriceStat({
  ...
  return (
    ...
    >
      <p className="flex items-center gap-1 font-mono text-[9px] font-semibold uppercase tracking-widest text-muted-foreground">
        {icon}
        {label}
      </p>
