                    ...
                    {storesQ.isLoading
                      ? Array.from({ length: 5 }).map((_, i) => (
                          <li
                            key={`sk-${i}`}
                            aria-hidden
                            className="grid h-[clamp(42px,4.6vh,52px)] w-[clamp(42px,4.6vh,52px)] shrink-0 place-items-center overflow-hidden rounded-xl border bg-white p-1.5 shadow-[0_2px_10px_-4px_rgba(3,10,28,0.55)]"
