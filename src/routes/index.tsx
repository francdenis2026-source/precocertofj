...
function HomePage() {
  ...
  return (
    <div
      className="pc-home relative flex min-h-screen w-full flex-col overflow-x-hidden scroll-smooth contain-layout bg-background text-foreground font-sans pb-[env(safe-area-inset-bottom,0px)]"
    >
      ...
      <div className="relative z-10 flex min-h-screen flex-col pb-[env(safe-area-inset-bottom,0px)] md:pb-0">
        ...
        <footer
          className="shrink-0 border-t px-4 py-6 sm:px-6 lg:px-8 mt-4 md:mt-8 bg-card/60 backdrop-blur-md md:mb-0 pb-[calc(1.5rem+76px)] md:pb-6"
        >
