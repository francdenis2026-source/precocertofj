  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative z-10 grid w-full max-w-[880px] grid-cols-1 overflow-hidden rounded-2xl border border-slate-900/10 bg-white text-slate-900 shadow-[0_30px_80px_-30px_rgba(6,20,45,0.35)] sm:rounded-3xl md:h-[560px] md:grid-cols-[minmax(0,4fr)_minmax(0,6fr)] dark:shadow-[0_30px_80px_-30px_rgba(0,0,0,0.6)]"
      >
