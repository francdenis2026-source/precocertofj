          ...
          <div className="lg:col-span-9">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredProducts.map((product) => (
                <div 
                  key={(product as any).catalogSlug || (product as any).id}
                  ...
                  <div className="p-5">
                    ...
                    <div className="space-y-3 pt-4 border-t border-white/5">
                      <div className="flex items-center gap-2 text-[10px] text-[var(--text-tertiary)]">
                        ...
                        <span className="font-bold text-[var(--text-secondary)]">{(product as any).cheapestStore}</span>
                      </div>
                      <div className="flex items-center gap-2 text-[10px] text-[var(--text-tertiary)]">
                      ...
                      <div className="flex items-center gap-2 text-[10px] text-[var(--text-tertiary)]">
                        ...
                        <span>Atualizado {new Date((product as any).lastSeenAt || "").toLocaleDateString("pt-BR")}</span>
                      </div>
                    </div>
                  </div>
