...
export function Logo({
  ...
  return (
    ...
    >
      <div className={cn(
        "pcsb-logo-mark relative flex items-center justify-center rounded-[var(--radius-lg)] transition-all duration-500 group-hover:rotate-[10deg] group-hover:scale-110",
