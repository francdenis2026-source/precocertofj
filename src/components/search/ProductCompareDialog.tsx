      ...
      >
        <header className="flex items-center justify-between gap-2 border-b border-border px-4 py-2.5">
          <div className="min-w-0">
            ...
            >
              {entries.length} item{entries.length > 1 ? "s" : ""} · ordenado por custo total
            </h2>
          </div>
                          ...
                          >
                            ...
                            {fresh ? (
                              ...
                              >
                                ...
                                {fresh.stale ? "desatualizado · " : ""}{fresh.label} atrás
                              </p>
                            ) : null}
                          </td>
                        );
        ...
        <footer className="border-t border-border px-4 py-2.5">
          {totalSavings != null ? (
            <div className="mb-2 flex flex-wrap items-center gap-2 rounded-lg border border-savings/30 bg-savings/[0.06] px-3 py-2">
              ...
              <span className="font-mono text-[12.5px] text-muted-foreground">
                comparando o mais barato com o mais caro no mesmo carrinho
              </span>
            </div>
          ) : null}
          <p className="font-mono text-[12.5px] text-muted-foreground">
            Ordenado por custo total (somando o menor preço de cada item por
            mercado). Preço unitário em{" "}
            ...
            <span className="text-destructive">desatualizado</span>.
          </p>
          {(() => {
