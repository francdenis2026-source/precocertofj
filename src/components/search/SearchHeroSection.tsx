...
export function SearchHeroSection({ query }: { query: string }) {
  ...
  return (
    <section className="relative overflow-hidden rounded-[40px] border border-[var(--border-subtle)] bg-[var(--bg-surface)] p-8 md:p-12 shadow-[var(--pc-shadow-lg)] group/hero">
