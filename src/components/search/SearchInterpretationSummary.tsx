    ...
    >
        ...
        <span className="inline-flex items-center gap-1 rounded-full border border-accent-strong/40 bg-accent/10 px-2 py-0.5 font-mono text-[11px] font-semibold uppercase tracking-wide text-accent-strong">
          ...
          {onQueryChange ? (
            <button
              ...
              aria-label="Editar quantidade e unidade"
            >
      ...
      {editing ? (
        <span
          ...
          role="group"
          aria-label="Editor de quantidade"
        >
          <input
            type="text"
            inputMode="decimal"
            ...
            className="w-14 border-0 bg-transparent p-0 text-center font-mono text-[11px] font-semibold text-foreground focus:outline-none"
          />
          <select
            aria-label="Unidade"
            value={editUnit}
