...
export function SearchFiltersPanel({ isOpen, onToggle }: { isOpen: boolean; onToggle: () => void }) {
  ...
  return (
    <aside className={cn(
      "space-y-8 md:block h-fit hidden",
      isOpen && "block"
    )}>
      ...
      <div className="space-y-8 bg-[var(--bg-surface)] border border-[var(--border-subtle)] rounded-[var(--radius-xl)] p-6 shadow-[var(--pc-shadow-sm)]">
