  ...
  return (
    <div ref={wrapRef} className="relative w-full max-w-2xl mx-auto z-50 px-0 md:px-0">
      <form
        ...
        role="search"
        className={cn(
          "group relative flex items-center gap-3 rounded-[var(--radius-2xl)] border border-white/30 bg-white/20 backdrop-blur-md pl-4 pr-1.5 shadow-2xl transition-all duration-500",
