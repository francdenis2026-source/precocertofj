      ...
      <>
        <AnimatePresence>
          ...
          <motion.div
            ...
            className={cn("fixed z-[110] flex flex-col overflow-hidden rounded-[20px] border border-[var(--border-subtle)] shadow-[0_32px_80px_-20px_rgba(15,23,42,0.25)]", className)}
            style={{
              left: rect.left,
              top: rect.top,
              width: rect.width,
