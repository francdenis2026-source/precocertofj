    ...
    return (
      <main
        ...
        className={cn(
          ...
          "md:peer-data-[variant=inset]:m-2 md:peer-data-[state=collapsed]:peer-data-[variant=inset]:ml-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-[var(--radius-xl)] md:peer-data-[variant=inset]:shadow",
          className,
        )}
        {...props}
      />
...
>(
  (
    ...
    // Tooltips foram removidos do sistema — botões do menu retornam sempre o
    // botão puro, sem envelope de Tooltip, mesmo com a sidebar colapsada.
    void tooltip; void state; void isMobile;
    return button;
