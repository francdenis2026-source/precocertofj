                  ...
                  {preview ? (
                    ...
                    <div className="flex h-full w-full flex-col items-center justify-center gap-1 p-2 text-center text-xs text-muted-foreground">
                      ...
                      <button
                        ...
                        className="mt-1 inline-flex items-center gap-1 rounded border border-border/60 bg-background px-2 py-0.5 text-[10px] hover:border-foreground/40"
          ...
          >
            <div className="flex items-center justify-between gap-2">
              <div className="flex items-center gap-1.5">
                ...
                {r.errorCode && (
                  <span className="rounded bg-destructive/10 px-1 py-0.5 font-mono text-[9px] text-destructive">
                    {r.errorCode}
                  </span>
                )}
              </div>
